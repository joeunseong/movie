# 29_2 - 애플리케이션을 시작하거나 종료할 때 데이터를 로딩하고 저장할 옵저버를 추가한다.
...
### 작업 1: 애플리케이션을 시작하거나 종료할 때 작업을 수행할 옵저버를 만들라.
...
### 작업 2: DataLoaderListener 옵저버를 App 객체에 등록한 후 실행되는 걸 확인하라.
...
### 작업 3: DataLoaderListener 옵저버에서 데이터를 로딩하고 저장하게 하라.

-- 영화 정보 예제 데이터 
insert into movie_info(info_id, mv_titl, conts, gr, director, act, kmrb, op_day, rn)
...
-- 게시물 예제 데이터
insert into movie_review(review_id, mv_titl, rv_sm, up_day, vw_cnt) 
  values(1, '세 얼간이', '내용1', '2011-09-10');
  
insert into movie_review(review_id, mv_titl, rv_sm, up_day, vw_cnt) 
  values(2, '겨울왕국1', '내용2', '2014-02-02');
  
insert into movie_review(review_id, mv_titl, rv_sm, up_day, vw_cnt) 
  values(3, '아이 캔 스피크', '내용3', '2018-03-05' );
  
insert into movie_review(review_id, mv_titl, rv_sm, up_day, vw_cnt) 
  values(4, '겨울왕국2', '내용4', '2020-12-08');
  
insert into movie_review(review_id, mv_titl, rv_sm, up_day, vw_cnt) 
  values(5, '정직한 후보', '내용5', '2020-03-10');

-- 수업 사진 게시물 예제 데이터
insert into lms_photo(photo_id, info_id, titl) 
